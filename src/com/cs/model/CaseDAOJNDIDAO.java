...
import javax.sql.DataSource;
	...
	public class CaseDAOJNDIDAO implements CaseDAO_interface{
		...
		public final static String GET_ALL_STMT = "SELECT CSNO, CSNAME, HIRERNO, FREELANCERNO, CSPAYMENT, CSSTATE, CSPAYSTATE,CSLEVEL STARTDATE,FREELANCERSCORE,to_char(ENDDATE,'YYYY-MM-DD') AS ENDDATE FROM CASE ORDER BY CSNO";
